var usuarioModel = require("../models/jogadorModel");
            ...
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        console.log("Dados que serão enviados para o front-end:");

                        jogadorModel.buscarPorJogador(resultadoAutenticar[0].jogadorId)
...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(fkjogador, nome, email, senha)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
